...
#property description "Breakout OCO V8 - Exit/Entry Hardening from V6 & V7 CSV Analysis"

//============================== INPUTS ==============================
// --- General ---
input int      MagicNumber              = 9001060;
input string   EA_Name                  = "EA_Breakout_OCO_V8";
...
input double   SellEntryExtraADX         = 3.0;    // [V8-03] Extra ADX required on top of MainEntryMinADX for SELL entries only
...
input double   SoftSL_USD               = 12.0;   // [V8-02] was 20.0: trigger earlier so momentum exit catches losses before they grow
...
input double   TimeLossExit_HardMultiplier = 1.5;  // [V8-01] Safety-net: cut regardless of confirmation once loss reaches TimeLossExitUSD * this
...
// --- Filters ---
input int      MaxSpreadPoints           = 38;   // [V8-05] was 45: V6 log showed spread<35 trades far more profitable than 35-40
...
input double   SellLotMult               = 0.85;  // [V8-06] Extra lot scaling applied only to SELL-direction main lot (SELL underperformed BUY in V6/V7 logs)
